...
If any two subsequent correct submissions are less than 120 seconds appart the program will print out the fastest two submissions with number of seconds as well as the two assignments.\
